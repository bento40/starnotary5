...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        if (ownerOf(_tokenId1) == msg.sender) {
            // if msg.sender own token 1
            _transferFrom(ownerAddress2, ownerAddress1, _tokenId2); //transfer owneraddress 2 token 2 to msg.sender, and transfer from msg.sender tokenid 1 to address2
            _transferFrom(ownerAddress1, ownerAddress2, _tokenId1);
        } else {
            // if msg.sender own token 2
            _transferFrom(ownerAddress2, ownerAddress1, _tokenId1);
            _transferFrom(ownerAddress1, ownerAddress2, _tokenId2);
        }
    }
